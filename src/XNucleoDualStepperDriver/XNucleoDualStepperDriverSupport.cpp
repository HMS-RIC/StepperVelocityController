...
unsigned long XNucleoStepper::paramHandler(byte param, unsigned long value)
{
...
unsigned long XNucleoStepper::xferParam(unsigned long value, byte bitLen)
{
  ...
  for (int i = 0; i < byteLen; i++)
  {
    ...
    retVal |= ((unsigned long)temp<<((byteLen-i-1)*8)) ;
  }
